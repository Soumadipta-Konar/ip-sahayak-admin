...
export const GovtBanner: React.FC = () => {
  ...
  return (
    <header className="w-full bg-white border-b-2 border-slate-300 shadow-none">
      {/* 1. Tricolor Top Accent Strip (Official India Flag Colors) */}
      ...
      <div className="bg-[#f1f3f6] border-b border-slate-300 text-[11px] text-slate-700 py-1.5 px-4 sm:px-8">
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-3 sm:gap-4 font-medium text-slate-700">
            <a 
              href="#main-content" 
              className="hover:text-blue-900 font-semibold transition-colors focus:underline"
            >
            ...
            >
              <Eye className={`w-3 h-3 ${isHighContrast ? 'text-amber-400' : 'text-slate-700'}`} />
            ...
            <div className="flex items-center gap-1">
              <span className="text-[10px] uppercase font-bold text-slate-600">Text Size:</span>
              <button 
                type="button" 
                onClick={() => handleSetSize('sm')}
                className={`px-1.5 py-0.5 border text-[10px] font-bold transition-all ${
                  activeSize === 'sm' 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 py-3.5 sm:py-5 flex flex-wrap items-center justify-between gap-6">
        {/* Ministry of AYUSH Emblem & Brand */}
        <div className="flex items-center gap-3.5 sm:gap-5">
          <div className="relative w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 flex-shrink-0 bg-white border-2 border-slate-300 p-1 flex items-center justify-center shadow-none">
            <Image
          ...
          <div>
            ...
            <h1 className="text-xl sm:text-2xl lg:text-3xl font-black text-[#002147] leading-tight tracking-tight">
              IP-SAKTI Sahayak
            </h1>
            <p className="text-xs sm:text-sm text-slate-700 font-medium max-w-xl mt-0.5">
              National AI Statutory Copilot for Ayurvedic Intellectual Property, TKDL Prior-Art & BDA 2023 &bull; SIH 045
            </p>
          </div>
        </div>

        {/* Dignitary Profile: Hon'ble Prime Minister of India (Official Institutional Framing) */}
        <div className="flex items-center gap-3.5 sm:gap-4 bg-[#f8f9fa] border-2 border-slate-300 p-2.5 sm:p-3 shadow-none">
          {/* Framed portrait: Square, double-border, zero shadow */}
          <div className="relative w-20 h-24 sm:w-28 sm:h-32 lg:w-32 lg:h-36 overflow-hidden border-2 border-[#002147] ring-1 ring-[#FF9933] flex-shrink-0 bg-white shadow-none">
            <Image
          ...
          <div className="text-left space-y-0.5">
            ...
            <p className="text-[11px] sm:text-xs text-slate-700 leading-tight font-semibold pt-0.5">
              Hon&apos;ble Prime Minister of India
            </p>
            
            <div className="pt-1.5 flex flex-col gap-1">
              <span className="inline-flex items-center gap-1 text-[10px] font-bold text-emerald-900 bg-emerald-100 border border-emerald-400 px-2 py-0.5 w-fit shadow-none">
